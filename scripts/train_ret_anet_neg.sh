#!/bin/bash
#SBATCH --gres=gpu:2
#SBATCH --job-name=sl_ret_mil_beta
#SBATCH --exclude=worker-2,worker-3,worker-4
...
output_dir=/home/wiss/zhang/Jinhe/singularity/mil/ret_${dataset}/${dataset}_${exp_name}
