...
sbatch scripts/eval_ret.sh anet /home/wiss/zhang/Jinhe/singularity/eccv_reb/ret_anet/anet_anet_vit_6/ckpt_best.pth anet_vit_6_sup_sup local 1 12353 \ test_types=[counter_contact] video_input.num_frames_test=12 \ add_temporal_embed=True \ temporal_vision_encoder.enable=True \ temporal_vision_encoder.num_layers=6
