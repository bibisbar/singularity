...
sbatch scripts/eval_anet.sh anet /home/wiss/zhang/Jinhe/singularity/qa_anet/anet_neg_1_from_scratch_correction_state/ckpt_best.pth union_answer_anet_eval_neg_1_from_scratch_correction_state local 1 45002 \ video_input.num_frames=4 \ add_temporal_embed=True \ temporal_vision_encoder.enable=True \ temporal_vision_encoder.num_layers=2 \ answer_list=/nfs/data2/zhang/AnetQA/qa_train/answer_list_light.json
...
sbatch scripts/eval_anet.sh anet /home/wiss/zhang/Jinhe/singularity/mil/ret_anet/anet_mil_beta_0.5_7_pos_no_ave_1_neg/ckpt_best.pth union_answer_anet_eval_mil_beta_0.5_7_pos_no_ave_1_neg_correction_state local 1 60000 \ video_input.num_frames=4 \ add_temporal_embed=True \ temporal_vision_encoder.enable=True \ temporal_vision_encoder.num_layers=2 \ answer_list=/nfs/data2/zhang/AnetQA/qa_train/answer_list_light.json
